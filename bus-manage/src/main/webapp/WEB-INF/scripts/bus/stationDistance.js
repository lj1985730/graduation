!function ($) {
    ...
    var baseUrl = 'bus/stationDistance';
    var $table;
    var $editWin;
    var $editForm;
    ...
    $(function() {
        ...
        $table = $('#stationDistanceTable');

        $table.bootstrapTable(
            $.extend({
                url : rootDir + 'bus/stationDistances',
         ...
         * 按钮初始化
         */
        $('#addStationDistance').on('click', function() { showEditWin(0); });
        $('#modifyStationDistance').on('click', function() { showEditWin(1); });
        $('#deleteStationDistance').on('click', function() { remove(); });
         ...
         * 选择框
         */
        $('#stationA').comboData('STATION', false, null, true);
        $('#stationB').comboData('STATION', false, null, true);
    });
    ...
    var showEditWin = function(saveOrUpdate) {
        ...
        try {
            ...
            if(sOrU === 1) {
                ...
                $("#editWinTitle").html("修改站点距离信息");
                $editWin.modal("show");
            } else if(sOrU === 0) {
                $("#editWinTitle").html("添加站点距离信息");
                $editWin.modal("show");
            }
        } catch(e) {
