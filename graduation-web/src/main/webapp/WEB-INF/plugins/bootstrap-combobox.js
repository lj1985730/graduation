	...
	Combobox.prototype = {
		...
		template : function() {
			if (this.options.bsVersion == '2') {
				return '<div class="combobox-container"><input type="hidden" /> <div class="input-append"> <input type="text" autocomplete="off" />  </div> </div>'
				//<span class="add-on dropdown-toggle" data-dropdown="dropdown">  <i class="icon-remove"/> </span>
			} else {
